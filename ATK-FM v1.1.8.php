<?php // been updated automatically on 2021/10/17 - Oct (Sun) 22:17:48(UNIXTIME:1634476668) from https://www.activetk.cf/ATK-FM/update/go/1.1.8.php
  /////////////////////////////////////////////////
  define('fmversion', 'v1.1.8');
  define('lastupdateinfo', '2021/10/17 - Oct (Sun) 22:17:48');
  define('publishupdateinfo', '2021/10/17 - Oct (Sun) 22:14:02');
  define('copyright',
...
<html lang="ja" dir="ltr">
  <head>
    ...
    var atkfm={};(function (window, undefined) {
      ...
      atkfm.MakeZip = function(ed) {
        ...
        .fail(
          function(e, n, t) {
            _("info").innerHTML="エラー:zip圧縮出来ませんでした。詳細 : " + t
          }
        )
      }
      ...
      atkfm.CloneItem = function() {
        ...
        .fail(
          function(e, n, t) {
            _("info").innerHTML="エラー:URLからファイルをアップロード出来ませんでした。詳細 : " + t;
          }
        );
      }
      ...
      atkfm.DirectoryRemove = function(e) {
        if (confirm("本当にディレクトリを削除しますか？"))
        {
          ...
          .fail(
            function(e, n, t) {
              _("info").innerHTML = "エラー:ディレクトリを削除出来ませんでした。詳細 : " + t;
            }
          )
        }
      }
      ...
      atkfm.AddItem = function() {
        ...
        .fail(
          function(e, n, t) {
            _("info").innerHTML="エラー:ファイルを作成出来ませんでした。詳細 : " + t;
          }
        )
      }
      ...
      atkfm.RenameItem = function(e, n) {
        ...
        .fail(
          function(e, n, t) {
            _("info").innerHTML = "エラー:ファイル名を変更出来ませんでした。詳細 : " + t;
          }
        )
      }
      ...
      atkfm.CopyItem = function(e) {
        ...
        .fail(
          function(e, n, t) {
            _("info").innerHTML = "エラー:ファイルをコピー出来ませんでした。詳細 : " + t;
          }
        )
      }
      ...
      atkfm.AddDirectory = function(e) {
        ...
        .fail(
          function(e, n, t) {
            _("info").innerHTML = "エラー:ディレクトリを作成出来ませんでした。詳細 : " + t;
          }
        )
      }
        ...
        $.ajax(
          {
            ...
            dataType: "json",
            success : function(e) {
              _("info").innerHTML = e.File + "個のファイル、" + e.Directory + "個のディレクトリがあります。計測時間:" + e.Time.toFixed(3) + "秒、サイズ:" + e.SIZE
            }
          }
        )
        .fail(
        ...
        $.ajax(
          {
            ...
            type   : "get",
            success: function(e) {
              _("info").innerHTML = "ファイルのサイズ: " + e;
            }
          }
        )
        .fail(
          function(e, n, t){
            _("info").innerHTML = "エラー:ファイルのサイズを取得出来ませんでした。詳細 : " + t;
          }
        )
      }
      ...
      atkfm.OpenZip = function(e) {
        ...
        .fail(
          function(e, n, t) {
            _("info").innerHTML = "エラー:ファイルを展開出来ませんでした。詳細 : " + t;
          }
        )
      }
      ...
      atkfm.CopyD = function(e) {
        ...
        .fail(
          function(e, n, t) {
            _("info").innerHTML = "エラー:ディレクトリをコピー出来ませんでした。詳細 : " + t;
          }
        )
      }
      ...
      window.onload=function(){atkfm.GetFileList(),(()=>{let e=0,t=0;

    _("min-upload-file").onsubmit=(async i=>{i.preventDefault();
    let a=_("file2").files[0];e=a.size;let n=1*_("upload-mb").value*1024*1024;t=Math.ceil(e/n);
    for(let e=0;e<t;e++){let i=new FormData;i.append("data",a.slice(e*n,(e+1)*n)),i.append("filename",_("file2").files[0].name),
    _("info").innerText="ファイルを分割アップロードしています。。("+Math.ceil(100*(e+1)/t).toString()+"%完了)",_("config").innerText="Upload %: "+Math.ceil(100*(e+1)/t).toString()
    +"\nUploaded/Total: "+e+"/"+t;
    await fetch("<?=$meurl?>?ajax-typeof=min-upload-item",{body:i,method:"POST",headers:{Accept:"application/json"},cache:'no-cache'})
      .then(e=>e.json())
      .catch(error1=>{console.error("ATKFM.Exception: Upload.Try1: "+error1);_("config").innerText+="\n* Warn: ATKFM.Exception: Upload.Try1: "+error1;
        fetch("<?=$meurl?>?ajax-typeof=min-upload-item",{body:i,method:"POST",headers:{Accept:"application/json"},cache:'no-cache'})
          .then(e=>e.json())
          .catch(error2=>{console.error("ATKFM.Exception: Upload.Try2: "+error2);_("config").innerText+="\n* Warn: ATKFM.Exception: Upload.Try2: "+error2;
            fetch("<?=$meurl?>?ajax-typeof=min-upload-item",{body:i,method:"POST",headers:{Accept:"application/json"},cache:'no-cache'})
              .then(e=>e.json())
              .catch(error3=>{console.error("ATKFM.Exception: Upload.Try3: "+error3);_("config").innerText += "\n* !Fatal: ATKFM.Exception: Upload.Try3: "+error3;_("info").innerText="エラー: 分割アップロード出来ませんでした。ネットワークを確認してください。";
                return false;});});});
    await new Promise(e=>setTimeout(()=>{e()},10))}
    return atkfm.SendBeacon_UploadFinished(_("file2").files[0].name),_("info").innerText="ファイルを分割アップロードしました！",_("file2").value="",atkfm.GetFileList(),!1})})()};
  ...
  <body style="background-color:#e6e6fa;text:#363636;">
    ...
    <div id="client" style="text-align:left;position:fixed;bottom:2%;left:02%;height:92%;width:46%;background-color:#6495ed;color:#080808;overflow-x:hidden;overflow-y:visible;">
      <form action='<?=$meurl?>' method='POST' onsubmit="_atkfm.AddItem();return false;">
      ...
      <form action='<?=$meurl?>' method='POST' onsubmit="AddDirectory();return false;">
        ...
        <input type='button' onclick="atkfm.AddDirectory();" value="新規作成">
      </form>
      ...
      アクセス制限: <a href='javascript:return false;void(atkfm.AccessCt())' title="現在作成中、v1.2.nあたりで実装予定です">
    ...
    <div id="server" style="text-align:left;position:fixed;bottom:2%;left:50%;height:92%;width:46%;background-color:#6495ed;color:#080808;overflow-x:hidden;overflow-y:visible;">
      <form action='<?=$meurl?>' method='POST' onsubmit='atkfm.GetFileList();return false;'>
        ...
        <input type='button' onclick='"/"==_("directory-root").value.substr(-1,1)&&(_("directory-root").value=_("directory-root").value.slice(0,-1)),_("directory-root").value=_("directory-root").value.substring(0,_("directory-root").value.lastIndexOf("/")),atkfm.GetFileList();' value="1つ上へ">
