<?php // been updated automatically on 2021/06/30 - Jun (Wed) 20:41:49(UNIXTIME:1625053309) from https://www.activetk.cf/ATK-FM/update/go/1.1.0.php
  /////////////////////////////////////////////////
  define('fmversion', 'v1.1.0');
  define('lastupdateinfo', '2021/06/30 - Jun (Wed) 20:41:49');
  define('publishupdateinfo', '2021/06/26 - Jun (Sat) 12:27:12');
  define('copyright',
...
<html lang="ja" dir="ltr">
  <head>
    ...
    function MakeZip(ed){$.ajax({url:"<?=$meurl?>?ajax-typeof=make-zip&ajax-option="+encodeURIComponent(ed),type:"get",success:function(e){_("info").innerHTML=e,GetFileList()}}).fail(function(e,n,t){_("info").innerHTML="エラー:zip圧縮出来ませんでした。詳細 : "+t})}
    ...
    :"b"==t?_("server-data").innerHTML+"<img src='"+ffimage+"' style='width:22px;height:22px;'>"+o+'(フォルダー)<a href=\'javascript:_("directory-root").value="'+n+"\";GetFileList();'><input type='button' value='開く'></a><a href='javascript:DirectoryRemove(\""+n+"\");'><input type='button' value='削除'></a><a href='javascript:MakeZip(\""+n+"\");'><input type='button' value='圧縮'></a><a href='javascript:RenameItem(\""+n+"\");'><input type='button' value='リネーム'></a><a href='javascript:CopyD(\""+n+"\");'><input type='button' value='コピー'></a><a href='javascript:CountDirectoryFiles(\""+n+"\");'><input type='button' value='詳細'></a><br>":"c"==t?_("server-data").innerHTML+
