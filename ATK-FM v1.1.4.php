<?php // been updated automatically on 2021/07/14 - Jul (Wed) 16:55:25(UNIXTIME:1626249325) from https://www.activetk.cf/ATK-FM/update/go/1.1.4.php
  /////////////////////////////////////////////////
  define('fmversion', 'v1.1.4');
  define('lastupdateinfo', '2021/07/14 - Jul (Wed) 16:55:25');
  define('publishupdateinfo', '2021/07/14 - Jul (Wed) 16:47:51');
  define('copyright',
...
<html lang="ja" dir="ltr">
  ...
  <body style="background-color:#e6e6fa;text:#363636;">
    ...
    <div id="client" style="text-align:left;position:fixed;bottom:2%;left:02%;height:92%;width:46%;background-color:#6495ed;color:#080808;overflow-x:hidden;overflow-y:visible;">
      ...
      アクセス制限: <a href='javascript:return false;void(AccessCt())' title="現在作成中、v1.1.4～v1.2.0あたりで実装予定です">
