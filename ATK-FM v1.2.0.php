<?php // been updated automatically on 2021/11/14 - Nov (Sun) 21:47:24(UNIXTIME:1636894044) from https://www.activetk.cf/ATK-FM/update/go/1.2.0.php
  /////////////////////////////////////////////////
  define('fmversion', 'v1.2.0');
  define('lastupdateinfo', '2021/11/14 - Nov (Sun) 21:47:24');
  define('publishupdateinfo', '2021/11/14 - Nov (Sun) 21:46:48');
  define('copyright',
...
<? }
  ...
  foreach($list as $value)
  {
    ...
    if ($filepath['extension'] == "png")
      ...
      echo "<iframe style='width:604px;height:340px;' src='{$meurl}?ajax-typeof=get-item&ajax-option=" . urlencode($value) . "&accept=text/plain'></iframe>";
  ...
  <head>
    ...
    var atkfm={};(function (window, undefined) {
      ...
      atkfm.MakeLink = function() {
        ...
        .fail(
          function(e, n, t) {
            _("info").innerHTML="エラー:リンクを作成出来ませんでした。詳細 : " + t;
          }
        )
      }
      ...
      atkfm.GetLinkTo = function(e) {
        ...
        .fail(
          function(e, n, t) {
            _("info").innerHTML = "エラー:リンク先を取得出来ませんでした。詳細 : " + t;
            atkfm.GetLink_Res = "";
          }
        )
        .always(
                        ...
                        error2 => {
                          ...
                          .catch(
                            error3 => {
                              ...
                              _("info").innerText = "エラー: 分割アップロード出来ませんでした。ネットワークを確認してください。";
                              return false;
                            }
                          );
                        }
