<?php // been updated automatically on 2021/06/30 - Jun (Wed) 20:41:01(UNIXTIME:1625053261) from https://www.activetk.cf/ATK-FM/update/go/1.0.9.php
  /////////////////////////////////////////////////
  define('fmversion', 'v1.0.9');
  define('lastupdateinfo', '2021/06/30 - Jun (Wed) 20:41:01');
  define('publishupdateinfo', '2021/06/20 - Jun (Sun) 19:39:47');
  define('copyright',
    ...
    <div align="center">
      ...
      <table border="1" style="position:relative;">
        ...
        <tr>
          ...
          <?php
            // In PHP 5.4 or more versions earlier, this program will throw that Parse error: syntax error, unexpected '['
            // In PHP 5.5.38, you can use but we don't support
            if (version_compare(PHP_VERSION, '5.6', '<')) {
              echo '<th style="position:relative;background-color:#ff0000;">' . PHP_VERSION . " (未対応のバージョンです、今すぐにアップデートしてください)";
            }
            // In PHP 7.2.34, you can use but we hope to use more new versions
        ...
        <tr>
          <th style="position:relative;">Loadavg[2]:5分の平均負荷</th>
      ...
      <table border="1" style="position:relative;">
        ...
        <?php
          ...
          foreach($_SERVER as $name => $value)
          {
            ...
            echo "          <th style=\"position:relative;\">{$name}</th>\n";
            if ($value != "")
              echo "          <th style=\"position:relative;\">{$value}</th>\n";
            else
