<?php // been updated automatically on 2021/06/30 - Jun (Wed) 20:42:19(UNIXTIME:1625053339) from https://www.activetk.cf/ATK-FM/update/go/1.1.1.php
  /////////////////////////////////////////////////
  define('fmversion', 'v1.1.1');
  define('lastupdateinfo', '2021/06/30 - Jun (Wed) 20:42:19');
  ...
  if (isset($_GET["ajax-typeof"]) || isset($_GET["ajaxtypeof"]))
  {
    ...
    if ($command == "get-directory" || $command == "getdirectory")
    {
      ...
      if (!is_file(substr($hiki, 0, -1))) {
        ...
        $listof = array();
        if (file_exists("{$hiki}.denyfm")) exit(json_encode(array('atk-fm-error'=>'アクセスが拒否されました。')));
